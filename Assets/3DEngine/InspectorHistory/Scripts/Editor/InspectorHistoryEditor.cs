...
public class InspectorHistoryEditor : EditorWindow
{
    ...
    private void OnEnable()
    {
        ...
        if (!skin)
            skin = AssetDatabase.LoadAssetAtPath<GUISkin>("Assets/3DEngine/InspectorHistory/Resources/InspectorHistorySkin.guiskin");
        if (buttonStyle == null)
    ...
    {
        //get data
        var data = AssetDatabase.LoadAssetAtPath<InspectorHistoryData>("Assets/3DEngine/InspectorHistory/Resources/InspectorHistoryData.asset");
        if (data)
            return data;
        else//create if doesnt exist
        {
            var asset = CreateInstance<InspectorHistoryData>();
            AssetDatabase.CreateAsset(asset, "Assets/3DEngine/InspectorHistory/Resources/InspectorHistoryData.asset");
    ...
    {
        return AssetDatabase.LoadAssetAtPath<GUISkin>("Assets/3DEngine/InspectorHistory/Resources/InspectorHistorySkin.guiskin");
    }
