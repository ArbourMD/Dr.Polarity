...
public class ProjectileDataEditor : ItemDataEditor
{
    ...
    protected override void SetProperties()
    {
        ...
        EditorExtensions.LabelFieldCustom("Projectile Properties", FontStyle.Bold);
        launchFX.ArrayFieldButtons("FX", true, true, true, true, EngineEventExtensions.EngineEventField);
        ...
        impactFX.ArrayFieldButtons("FX", true, true, true, true, EngineEventExtensions.EngineEventField);
