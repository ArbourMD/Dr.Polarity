...
public class UserDataManager : ScriptableObject
{
    ...
    {
        dataPath = Application.streamingAssetsPath + "/UserManager";
        GetDataFromFile();
    }
    ...
    {
        byte[] bytes = BinarySerialization.SerializeBinary(userContainer);
    ...
    void ReadDataFromFile()
    {
        ...
        userContainer = BinarySerialization.DeserializeBinary<UserContainer>(bytes);
