...
public static class Utils
{
    ...
    public static void SetParent(this Transform _transform, Transform _parent, bool _worldPosStays, bool _resetTransformValues)
    {
        _transform.SetParent(_parent, _worldPosStays);
        if (_resetTransformValues)
        {
            if (!_worldPosStays)
