...
public class UnitControllerEditor : Editor
{
    ...
    protected virtual void DisplayAI()
    {
        ...
        arrivalDistance.FloatFieldClamp(0.1f, 10);
        arrivalTime.FloatFieldClamp(0, Mathf.Infinity);
    ...
    void DrawWanderDebug()
    {
        ...
        Handles.DrawSolidDisc(center + (Vector3.up * 0.01f), Vector3.up, wanderRadius.floatValue);
    }
